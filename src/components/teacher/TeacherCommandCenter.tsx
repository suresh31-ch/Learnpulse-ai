...
export const TeacherCommandCenter: React.FC<TeacherCommandCenterProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <LearningLoopBar currentStageId="gap_detection" onSelectStage={(stageId) => {
        if (stageId === 'pre_class_preview') onNavigateTab('pre_class_intelligence');
        if (stageId === 'gap_detection' || stageId === 'risk_analysis') onNavigateTab('risk_radar');
        if (stageId === 'intervention') onNavigateTab('interventions');
      }} />
