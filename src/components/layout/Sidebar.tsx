    ...
    switch (currentRole) {
      case 'student':
        return [
          ...
          { id: 'pre_class', label: 'Pre-Class', icon: CalendarCheck },
      ...
      case 'teacher':
        return [
          ...
          { id: 'risk_radar', label: 'Risk Radar', icon: Radar },
          { id: 'misconception_lab', label: 'Misconception Lab', icon: FlaskConical },
          { id: 'pre_class_intelligence', label: 'Pre-Class Intel', icon: CalendarCheck },
          { id: 'ai_questions', label: 'AI Questions', icon: HelpCircle },
          { id: 'ai', label: 'AI', icon: Brain, badge: 'Intelligence' },
        ];
